    ...
    <div className="flex items-center justify-between py-5 font-medium">
      ...
      <div className="flex items-center gap-6">
        ...
        <img
          ...
          className="w-5 cursor-pinter sm:hidden"
      ...
      {/* for small screens*/}
      <div
        className={`border rounded absolute top-0 right-0 bottom-0 overflow-hidden bg-white transition-all ${
          visible ? "w-[250px] h-dvh" : "w-0"
        }`}
      >
        <div className="flex flex-col text-gray-600">
          ...
          <NavLink
            onClick={() => setVisible(false)}
            className="side-nav border py-2 pl-6"
            to="/"
          >
            HOME
          </NavLink>
